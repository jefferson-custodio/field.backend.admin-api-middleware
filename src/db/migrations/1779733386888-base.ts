...
export class Base1779733386888 implements MigrationInterface {
    name = 'Base1779733386888'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."user_fund_access_reporttype_enum" AS ENUM('RECEIVABLES', 'ASSET_PORTFOLIO', 'LIABILITY_PORTFOLIO', 'CONSOLIDATED_ACQUISITION', 'MARKET', 'LIQUIDADOS_BAIXADOS', 'LIQUIDADOS_BAIXADOS_V2', 'MOVIMENTO_ABERTO')`);
        await queryRunner.query(`CREATE TABLE "user_fund_access" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "reportType" "public"."user_fund_access_reporttype_enum" NOT NULL, "userId" integer, "fundId" integer, CONSTRAINT "PK_5b1f4f96cf88ba04ba7cf8d3c08" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "user_fund_access" ADD CONSTRAINT "FK_a5ff8dae4a3b53ffa49372278d4" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_fund_access" ADD CONSTRAINT "FK_a36d98cb8cfba22af5a5800143b" FOREIGN KEY ("fundId") REFERENCES "fund"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "user_fund_access" DROP CONSTRAINT "FK_a36d98cb8cfba22af5a5800143b"`);
        await queryRunner.query(`ALTER TABLE "user_fund_access" DROP CONSTRAINT "FK_a5ff8dae4a3b53ffa49372278d4"`);
        ...
        await queryRunner.query(`DROP TABLE "user_fund_access"`);
        await queryRunner.query(`DROP TYPE "public"."user_fund_access_reporttype_enum"`);
